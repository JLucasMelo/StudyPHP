      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
        ...
        <form method="post">
          ...
          <div class="form-group">
            ...
            <input class="form-control" type="text" name="name" id="name" placeholder="Nome Completo" value="<?php print($rowUser['name']); ?>" required maxlength="100">
          </div>
          <div class="form-group">
            <label for="email">Email *</label>
            <input class="form-control" type="text" name="email" id="email" placeholder="Use xxxxx@xxx.xxx" value="<?php print($rowUser['email']); ?>" required maxlength="100">
          </div>
